...
namespace Pulumi.Openai
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Openai.version.txt");
    ...
    internal sealed class OpenaiResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public OpenaiResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
