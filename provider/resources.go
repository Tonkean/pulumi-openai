...
const (
	...
	mainPkg = "openai"
	// modules:
	mainMod = "index" // the openai module
)

//go:embed cmd/pulumi-resource-openai/bridge-metadata.json
var metadata []byte
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		//
		//    - In provider/cmd/pulumi-tfgen-openai/main.go, replace the
		...
		//
		//    - In provider/cmd/pulumi-resource-openai/main.go, replace the
		...
		// convention is to have a function at "github.com/iwahbe/terraform-provider-openai/provider".New
		...
		Keywords:   []string{"Tonkean", "openai", "category/cloud"},
		License:    "Apache-2.0",
		...
		Golang: &tfbridge.GolangInfo{
			ImportBasePath: path.Join(
				"github.com/tonkean/pulumi-openai/sdk/",
	...
	prov.MustComputeTokens(tokens.SingleModule("openai_", mainMod,
